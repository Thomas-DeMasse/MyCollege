...
token scan() {
    ...
    if (std::isalpha(c)) {
        ...
        else if (!std::strcmp(token_image, "if")) return t_if;
        else if (!std::strcmp(token_image, "while")) return t_while;
        else if (!std::strcmp(token_image, "endif")) return t_endif;
         else if (!std::strcmp(token_image, "endwhile")) return t_endwhile;
